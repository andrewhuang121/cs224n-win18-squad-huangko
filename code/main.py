...
tf.app.flags.DEFINE_float("exp_moving_avg", 0.999, "Exponential Moving Average")
...
tf.app.flags.DEFINE_integer("save_every", 250, "How many iterations to do per save.")
tf.app.flags.DEFINE_integer("eval_every", 250, "How many iterations to do per calculating loss/f1/em on dev set. Warning: this is fairly time-consuming so don't do it too often.")
